...
- **💰 Multi-Currency Support**: Log transactions in USD, EUR, or JPY with automatic conversion to a base currency (USD) for consistent totals.
...
2.  **Add Transactions**:
    ...
    -   Click the **red plus button** if you owe them more.
    -   Click the **green minus button** if you've paid them back some amount.
